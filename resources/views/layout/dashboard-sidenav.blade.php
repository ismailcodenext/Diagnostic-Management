...
<body>
    ...
    <div class="main-wrapper">
        ...
        <a class="btn" id="searchdiv"><img src="{{asset('front-end/assets/img/icons/search.svg')}}" alt="img"></a>
        </form>
        </div>
        </li>
        ...
        <img alt="" src="{{asset('front-end/assets/img/profiles/avatar-02.jpg')}}">
        </span>
        ...
        <div class="media d-flex">
        <span class="avatar flex-shrink-0">
        <img alt="" src="{{asset('front-end/assets/img/profiles/avatar-03.jpg')}}">
        </span>
        <div class="media-body flex-grow-1">
        ...
        <div class="media d-flex">
        <span class="avatar flex-shrink-0">
        <img alt="" src="{{asset('front-end/assets/img/profiles/avatar-06.jpg')}}">
        </span>
        <div class="media-body flex-grow-1">
        ...
        <div class="media d-flex">
        <span class="avatar flex-shrink-0">
        <img alt="" src="{{asset('front-end/assets/img/profiles/avatar-17.jpg')}}">
        </span>
        <div class="media-body flex-grow-1">
        ...
        <div class="media d-flex">
        <span class="avatar flex-shrink-0">
        <img alt="" src="{{asset('front-end/assets/img/profiles/avatar-13.jpg')}}">
        </span>
        <div class="media-body flex-grow-1">
