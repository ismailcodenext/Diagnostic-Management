<div class="page-wrapper">
    ...
    <div class="dash-widgetimg">
    <span><img src="{{asset('front-end/assets/img/icons/dash2.svg')}}" alt="img"></span>
    </div>
    <div class="dash-widgetcontent">
    ...
    <div class="dash-widgetimg">
    <span><img src="{{asset('front-end/assets/img/icons/dash3.svg')}}" alt="img"></span>
    </div>
    <div class="dash-widgetcontent">
    ...
    <div class="dash-widgetimg">
    <span><img src="{{asset('front-end/assets/img/icons/dash4.svg')}}" alt="img"></span>
    </div>
    <div class="dash-widgetcontent">
